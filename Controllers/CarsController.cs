...
using MVCCarTina.Data;
using MVCCarTina.Models;

namespace MVCCarTina.Controllers
{
    public class CarsController : Controller
    {
        private readonly MVCCarTinaContext _context;

        public CarsController(MVCCarTinaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Car != null ? 
                          ...
                          Problem("Entity set 'MVCCarTinaContext.Car'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MVCCarTinaContext.Car'  is null.");
            }
            var car = await _context.Car.FindAsync(id);
            if (car != null)
            {
